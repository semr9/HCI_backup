...
namespace KartGame.KartSystems
{
    public class ArcadeKart : MonoBehaviour
    {
        ...
        void FixedUpdate()
        {
            ...
            if (ComandoVoz && ComandoVoz.text == "turbo")
            {
                turboActivado = true;
                turbo = Time.time;
                ComandoVoz.text = "turbo activado";
            } else if (ComandoVoz &&  ComandoVoz.text == "stop")
            {
                Rigidbody.drag = 50;
                //accel -= 10;
            ...
            } else if (ComandoVoz && ComandoVoz.text == "start")
            {
